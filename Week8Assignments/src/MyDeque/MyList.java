 ...
 * <p>
 * overrides: add(), isEmpty(), remove(), containsAll(), addAll(), removedAll(),
 * retainAll(), toArray()
 * <p>
 * 
 * @author bobgils
...
public interface MyList<E> extends Collection<E> {
	...
	/**
	 * Add a new element at the end of this list-- overrides Collection.add()
	 */
	@Override
	...
	/**
	 * Return true if this list contains no elements -- overrides
	 * Collection.isEmpty()
	 */
	@Override
	 ...
	 * collection.-- overrides Collection.containsAll()
	 * 
	 * @param c
	 * @return boolean
	 */
	 ...
	 * (optional operation).-- overrides Collection.addAll()
	 * 
	 * @param c
	 * @return boolean
	 */
	 ...
	 * specified collection (optional operation).-- overrides Collection.removeAll()
	 * 
	 * @param c
	 * @return boolean
	 */
	 ...
	 * specified collection (optional operation)-- overrides Collection.retainAll()
	 * 
	 * @param c
	 * @return boolean
	 */
