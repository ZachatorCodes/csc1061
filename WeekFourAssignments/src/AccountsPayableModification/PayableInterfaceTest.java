...
public class PayableInterfaceTest 
{
   public static void main(String[] args)
   {
      ...
      try 
      {
            ...
            {
                    System.out.println("**?? Error: \"setFirst\" " +
            ...
            {
                    System.out.println("**?? Error: \"setLast\" " +
                                    "resulted in NullPointerException");
            }

            if( employee1.getLastName() != null )
                    System.out.println("**?? Error: \"getLast\" " +
                                    "did not return a null value");
            ...
            if( employee2.getFirstName() != null )
                    System.out.println("**?? After construction: \"getFirstName\" " +
                                    "did not return a correct value");
            if( !employee2.getSocialSecurityNumber().equals("1234") )
                    System.out.println(
                                    "**?? After construction: \"getSocialSecurityNumber\" " +
                                    "did not result in correct value");
            ...
            {
                    System.out.println("**?? Error in constructor: null " +
            ...
            System.err.println("**?? The source of the error can be found " +
                            "in this stacktrace:");
